...
"${tool}" "${flags[@]}" -c "${script_dir}/CC1310_LAUNCHXL.c" "${script_dir}/CC1310_LAUNCHXL_fxns.c" "${script_dir}/RFQueue.c" "${script_dir}/cli_core.c" "${script_dir}/cli_radio.c" "${script_dir}/cli_bootloader.c" "${script_dir}/cli_task_cc1310.c" "${script_dir}/main_tirtos.c" "${script_dir}/firmware.c" "${script_dir}/firmware_mode.c" "${script_dir}/firmware_startup.c" "${script_dir}/firmware_tx.c" "${script_dir}/rf_packet_queue.c" "${script_dir}/boot_api.c" "${script_dir}/boot_nonrom_startup.c" "${script_dir}/smartrf_settings/smartrf_settings.c"
