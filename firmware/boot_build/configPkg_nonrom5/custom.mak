...
linker.cmd: package/cfg/boot_release_pem3.xdl
	$(SED) 's"^\"\(package/cfg/boot_release_pem3cfg.cmd\)\"$""\"/Users/xiulin/workspace_ccstheia/rfPacketRx/boot_build/configPkg_nonrom5/\1\""' package/cfg/boot_release_pem3.xdl > $@
